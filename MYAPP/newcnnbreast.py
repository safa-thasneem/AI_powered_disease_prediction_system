...
def read_dataset():
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\safat\PycharmProjects\AI_DIESESE_PREDICTION\dataset\Breast Cancer')
    for pos,pa in enumerate(my_list):

        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\Users\safat\PycharmProjects\AI_DIESESE_PREDICTION\dataset\Breast Cancer\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\safat\PycharmProjects\AI_DIESESE_PREDICTION\dataset\Breast Cancer\\'+pa, f)
